...
namespace BlackCat\Database\Packages\PaymentGatewayNotifications\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO PaymentGatewayNotificationDto:
 ...
 */
final class PaymentGatewayNotificationDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'transaction_id' => 'transactionId', 'tenant_id' => 'tenantId', 'received_at' => 'receivedAt', 'version' => 'version', 'processing_by' => 'processingBy', 'processing_until' => 'processingUntil', 'attempts' => 'attempts', 'last_error' => 'lastError', 'status' => 'status' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'version', 'attempts' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'received_at', 'processing_until' ];
    /** @var string[] */
     ...
     * @return PaymentGatewayNotificationDto
     */
    public static function fromRow(array $row): PaymentGatewayNotificationDto
    {
        /** @var PaymentGatewayNotificationDto */
        return DtoHydrator::fromRow(
            PaymentGatewayNotificationDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?PaymentGatewayNotificationDto
    {
     ...
     *
     * @param PaymentGatewayNotificationDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(PaymentGatewayNotificationDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PaymentGatewayNotificationDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PaymentGatewayNotificationDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,PaymentGatewayNotificationDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,PaymentGatewayNotificationDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PaymentGatewayNotificationDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,PaymentGatewayNotificationDto>
     */
