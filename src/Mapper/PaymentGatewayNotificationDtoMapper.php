...
final class PaymentGatewayNotificationDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'transaction_id' => 'transactionId', 'received_at' => 'receivedAt', 'processing_by' => 'processingBy', 'processing_until' => 'processingUntil', 'last_error' => 'lastError' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'transaction_id', 'processing_by', 'processing_until', 'last_error' ];
    ...
    public static function fromRow(array $row): PaymentGatewayNotificationDto {
        ...
        return new PaymentGatewayNotificationDto(...$vals);
    }
