...
/**
 * Contract generated for PaymentGatewayNotification repositories.
 * Mirrors the public API of the generated repository so tests can type against the interface.
 */
interface PaymentGatewayNotificationRepositoryInterface extends RepoContract, KeysetRepoContract
{
    // --- INSERT / BULK -------------------------------------------------------
