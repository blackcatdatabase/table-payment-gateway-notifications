...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'transaction_id', 'tenant_id', 'received_at', 'version', 'processing_by', 'processing_until', 'attempts', 'last_error', 'status' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\PaymentGatewayNotifications\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\PaymentGatewayNotifications\Definitions::softDeleteColumn();
