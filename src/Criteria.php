 ...
 * - whitelist filtrů: [ 'id', 'transaction_id', 'received_at', 'version', 'processing_by', 'processing_until', 'attempts', 'last_error', 'status' ]
 * - whitelist LIKE:   [ 'transaction_id', 'processing_by', 'last_error', 'status' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'transaction_id', 'received_at', 'version', 'processing_by', 'processing_until', 'attempts', 'last_error', 'status' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'transaction_id', 'received_at', 'version', 'processing_by', 'processing_until', 'attempts', 'last_error', 'status' ], true);
            $parts = [];
