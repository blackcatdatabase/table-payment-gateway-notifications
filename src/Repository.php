...
{
    private PaymentGatewayNotificationRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new PaymentGatewayNotificationRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentGatewayNotifications\Dto\PaymentGatewayNotificationDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\PaymentGatewayNotifications\Dto\PaymentGatewayNotificationDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentGatewayNotifications\Dto\PaymentGatewayNotificationDto|null
    {
