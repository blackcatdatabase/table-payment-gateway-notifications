...
use BlackCat\Database\Packages\PaymentGatewayNotifications\Repository\PaymentGatewayNotificationRepository as GeneratedRepository;
...
{
  private PaymentGatewayNotificationRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PaymentGatewayNotificationRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected PaymentGatewayNotificationRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentGatewayNotifications\Dto\PaymentGatewayNotificationDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentGatewayNotifications\Dto\PaymentGatewayNotificationDto|null { return $this->repo->getById($id, $asDto); }
