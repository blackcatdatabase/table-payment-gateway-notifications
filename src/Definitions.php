...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'transaction_id', 'tenant_id', 'received_at', 'version', 'processing_by', 'processing_until', 'attempts', 'last_error', 'status' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'transaction_id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'version', 'attempts' ]; }
