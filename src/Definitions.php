...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'transaction_id', 'received_at', 'version', 'processing_by', 'processing_until', 'attempts', 'last_error', 'status' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'version', 'attempts' ]; }
