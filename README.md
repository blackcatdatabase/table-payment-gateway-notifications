...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 1 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\payment-gateway-notifications](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\payment-gateway-notifications)
...
graph LR
  ...
  payment_gateway_notifications["payment_gateway_notifications"]:::center
  payment_gateway_notifications -->|FK| payments["payments"]:::link
  payment_gateway_notifications -->|FK| tenants["tenants"]:::accent
...
- Outbound (depends on): "payments", "tenants"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package payment-gateway-notifications -Apply
