...
|-------:|:-----|:----:|:--------|:------|
| id | BIGINT | — | AS | PK |
| transaction_id | VARCHAR(255) | NO | — |  |
| tenant_id | BIGINT | NO | — |  |
| received_at | TIMESTAMPTZ(6) | NO | CURRENT_TIMESTAMP(6) |  |
| version | INTEGER | NO | 0 |  |
| processing_by | VARCHAR(100) | YES | — |  |
| processing_until | TIMESTAMPTZ(6) | YES | — |  |
| attempts | INTEGER | NO | 0 |  |
| last_error | VARCHAR(255) | YES | — |  |
| status | TEXT | NO | 'pending' |  |

## Relationships
- FK → **payments** via (tenant_id,transaction_id) (ON DELETE CASCADE).
...
erDiagram
  PAYMENT_GATEWAY_NOTIFICATIONS {
    ...
    TIMESTAMPTZ processing_until
    INTEGER attempts
    VARCHAR last_error
    VARCHAR status
  }
  PAYMENT_GATEWAY_NOTIFICATIONS }o--|| PAYMENTS : "tenant_id, transaction_id"
  PAYMENT_GATEWAY_NOTIFICATIONS }o--|| TENANTS : "tenant_id"
```
